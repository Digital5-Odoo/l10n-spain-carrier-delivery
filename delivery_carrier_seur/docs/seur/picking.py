...
class Picking(API):
    ...
    def create(self, data):
        ...
        cdata = tmpl.generate(**vals).render()
        vals.update({'cdata': cdata})
        
        if self.context.get('pdf'):
            tmpl2 = loader.load('picking_send_pdf_cdata.xml')
        else:
            tmpl2 = loader.load('picking_send_cdata.xml')
        ...
        xml = tmpl2.generate(**vals).render()
